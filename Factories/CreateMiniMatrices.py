...
def create_mini_matrices():
        ...
        cursor.execute("SELECT COUNT(*) FROM user_list WHERE user_id<2000;")
        ...
        cursor.execute("SELECT user_id, movie_id, rating FROM mini_training ORDER BY user_id ASC, movie_id ASC")
        ...
        # create test data
        test_cursor.execute("SELECT COUNT(*) FROM user_list WHERE user_id<40;")
        ...
        test_cursor.execute("SELECT user_id, movie_id, rating FROM mini_test ORDER BY user_id ASC, movie_id ASC")
        ...
        for query_row1 in test_cursor:
                test_row.append(query_row1[0])  # user_id
                test_col.append(query_row1[1])  # movie_id
